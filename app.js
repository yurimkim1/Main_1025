...
//app.use('/world', express.static(__dirname + './Webpage/blockland'));

// Webpage static 접근
app.use(express.static('./public_html/blockland'));
app.use(express.static('./public_html/blockland/libs'));
// nickname 입력창 접근
app.use('/world', express.static(__dirname + '/public_html/blockland'));
